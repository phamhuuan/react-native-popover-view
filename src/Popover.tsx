...
class AdaptivePopover extends Component<AdaptivePopoverProps, AdaptivePopoverState> {
  ...
  private screenResizeSubcription: EmitterSubscription | null = null;
  ...
  componentDidMount() {
    ...
    this.screenResizeSubcription = Dimensions.addEventListener('change', this.handleResizeEvent);
  ...
  componentWillUnmount() {
    this._isMounted = false;
		this.screenResizeSubcription.remove();
